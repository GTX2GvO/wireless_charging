...
data:extend
{
                        ...
                        "__wireless-charging__/graphics/entities/empty64.png"),
  {
    ...
    pictures =
    {
      ...
      window_background =
      {
        filename = "__wireless-charging__/graphics/entities/induction-station-window-background.png",
        priority = "low",
        width = 3,
        height = 11,
      },
      fluid_background =
      {
        filename = "__wireless-charging__/graphics/entities/induction-station-fluid-background.png",
        priority = "low",
        width = 3,
        height = 11,
      },
      flow_sprite =
      {
        filename = "__wireless-charging__/graphics/entities/induction-station-fluid-flow.png",
        priority = "low",
        width = 160,
        height = 3,
      },
